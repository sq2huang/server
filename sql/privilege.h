...
constexpr privilege_t PRIV_SET_SESSION_VAR_BINLOG_FORMAT= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_BINLOG_DIRECT_NON_TRANSACTIONAL_UPDATES= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_DEBUG_DBUG= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_DEBUG_SYNC= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_PSEUDO_THREAD_ID= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_GTID_DOMAIN_ID= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_GTID_SEQ_NO= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_SERVER_ID= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_ENFORCE_STORAGE_ENGINE= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_SQL_LOG_OFF= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_SQL_LOG_BIN= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_TIMESTAMP_SECTIME_SUPER= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_WSREP_ON= SUPER_ACL;
constexpr privilege_t PRIV_SET_SESSION_VAR_LOG_DISABLED_STATEMENTS= SUPER_ACL;
